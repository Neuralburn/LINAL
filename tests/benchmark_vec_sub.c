/*
 * @file benchmark_vec_sub.c
 * @brief Benchmark vec_sub across vector sizes with correctness validation.
 *
...
int main(void)
{
    ...
    printf("=== vec_sub benchmark (median of %d runs) ===\n", REPEATS);
    printf("%-12s %12s %10s\n", "Size", "Time(us)", "Valid");

/*
 * @file benchmark_mat_norm.c
 * @brief Benchmark mat_norm_l2 across matrix sizes with correctness validation.
 */
...
int main(void)
{
    ...
    if (all_valid)
        printf("METRIC mat_norm_l2_ms=%.6f\n", primary_ms);
    else
        printf("METRIC mat_norm_l2_ms=999999.000000\n");

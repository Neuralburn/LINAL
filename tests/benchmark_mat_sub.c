/*
 * @file benchmark_mat_sub.c
 * @brief Benchmark mat_sub across matrix sizes with correctness validation.
 */
...
main(void)
{
    ...
    if (all_valid) {
        printf("METRIC mat_sub_ns_elt=%.6f\n", primary_ns_elt);
    } else {
        printf("METRIC mat_sub_ns_elt=999999.000000\n");
    }
